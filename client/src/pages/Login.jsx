  ...
  return (
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      {state === 'Sign Up'? (
        ...
        <span onClick={() => setState('Login')} className='text-blue-400 cursor-pointer text-xs mt-4'>
          Login Here
        </span>
      </p>
      ) : (
        ...
        <span onClick={() => setState('Sign Up')} className='text-blue-400 cursor-pointer text-xs mt-4'>
          Sign Up
        </span>
      </p>
      )}      
